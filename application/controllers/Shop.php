...
class Shop extends CI_Controller {
    ...
    function id ( $shop_id, $nav = 'detail' ) {        
        /*******************
        data
        *******************/
        $data = array();
        ...
        *******************/
        ...
        if ( $nav == 'detail' ) {
            $data['container'] = $this->load->view('/front/shop/detail', $data, TRUE);            
        } else {
            $data['container'] = $this->load->view('/front/shop/product', $data, TRUE);            
        }
    ...
    function recommend () {
        ...
        *******************/
        ...
        $data['container'] = $this->load->view('/front/shop/recommend', $data, TRUE);
    ...
    function map () {        
        ...
        *******************/
        ...
        $data['container'] = $this->load->view('/front/shop/map', $data, TRUE);
    ...
    function index () {        
        ...
        *******************/
        ...
        $data['container'] = $this->load->view('/front/shop/list', $data, TRUE);
