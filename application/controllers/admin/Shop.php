    ...
    function id ( $user_id = 0, $sub_key = 'detail' ) {
        ...
        *******************/
        ...
        if ( $ajax ) {
            ...
            } elseif ( $sub_key == 'product' ) {
                $data['container'] = $this->load->view('/admin/shop/product', $data, TRUE);                
            } elseif ( $sub_key == 'sales' ) {
                $data['container'] = $this->load->view('/admin/shop/sales', $data, TRUE);                
            } elseif ( $sub_key == 'event' ) {
                $data['container'] = $this->load->view('/admin/shop/event', $data, TRUE);                                
            } else {
                show_404();                
            };
    ...
    function index ( $post_type = 0 ) {    
        ...
        *******************/
        ...
        if ( $ajax ) {
            ...
            if ( $post_type == 1 ) {
                $data['container'] = $this->load->view('/admin/shop/list_1', $data, TRUE);
            } else {
                show_404();                
            };
            $this->load->view('/admin/body', $data, FALSE);            
