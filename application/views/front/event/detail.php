...
<div class="wrap" id="hideMenu">
    ...
    <div class="list-wrap" id="container">
        <div class="list-row">
            <a href="">
                <h6><? if ( isset($row['post_content_title']) ) { echo $row['post_content_title']; }; ?></h6>
                <p><small><? if ( isset($row['post_register_date']) ) { echo date("Y-m-d", strtotime($row['post_register_date'])); }; ?></small></p>
            </a>
        </div>
        <div class="list-detail">
            ...
            <!--
            <p>
                투잡다모아 앱이 오픈되었습니다. 대한민국의 모든사람이 영업할수있는 그날까지 투잡다모아~
            </p>
            <img src="assets/images/noticecontentssample.png" width="100%">
            -->
        </div>
    </div>
</div>    
